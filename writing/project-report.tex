...
\begin{document}
	...
	\section{Bot Detection} 
		...
		The features for the model is built by accessing Twitter's API for user data \cite{twitter}. We include as features:
...
\begin{center}
	\begin{tabular}{c|c|c|c|c}%
		\bfseries Type & Accuracy & F1~score & Precision & Recall % specify table head
		\csvreader[head to column names]{results_classification.csv}{}% use head of csv as column names
		{\\\hline\type & \accuracy & \fscore & \precision & \recall}% specify your coloumns here
	\end{tabular}
\end{center}
